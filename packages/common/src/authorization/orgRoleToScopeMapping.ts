 ...
 *
 * Two more confirmed vocabulary gaps, surfaced during development by a
 * differential test harness comparing this mapping's output against the
 * (now-deleted) hand-written builder, are still live --
 ...
 * original hand-written output for every role by
